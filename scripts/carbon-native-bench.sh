...
case "${command}" in
  all | native-evidence)
    ...
    run_xtask bench-scheduler-architecture --tier quick --samples 5
    run_xtask bench-scalability --tier quick --families scheduler,native-scheduler,io,data --samples 5
