...
pub fn run_fixture_dir(path: impl AsRef<Path>) -> Result<FixtureDirReport> {
    ...
    Ok(FixtureDirReport {
        ...
        coverage: "event_or_final_state_checked_trace_expectations_checked_event_run_count_calculated_run_count_invariant_checked_scheduler_semantic_fixtures_tasklet_run_invalid_run_switch_no_mutation_bind_setup_rebind_schedule_run_n_limited_schedule_order_timeout_counters_nested_timeout_remainder_scheduled_remove_nested_schedule_multi_level_blocked_yield_scheduler_switch_trap_no_mutation_switch_trap_nested_level_channel_callback_preference_neutral_order_main_side_preference_fixture_teardown_blocked_channel_cleanup_close_clear_pending_teardown_cleanup_exception_throw_closed_channel_deadlock",
