...
pub fn run_fixture_dir(path: impl AsRef<Path>) -> Result<FixtureDirReport> {
    ...
    Ok(FixtureDirReport {
        ...
        status,
        report_ready: false,
        coverage: "initial_event_checked_invariant_checked_scheduler_semantic_fixtures_tasklet_run_bind_setup_rebind_schedule_run_n_timeout_counters_timeout_remainder_scheduled_remove_nested_schedule_multi_level_blocked_yield_channel_preference_neutral_order_main_side_preference_close_cleanup_exception_throw_closed_channel_deadlock",
