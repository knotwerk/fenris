    ...
    let mut evidence = json!({
        ...
        "core_ownership_status": {
            ...
            "already_rust_owned": [
                ...
                "Python-visible channel preference/closing/closed properties now read CoreScheduler snapshots, while Python payload queues remain bridge-local compatibility state",
